...
2. The application will start capturing packets. Press `Ctrl+C` to stop the capture.

3. After stopping the capture, the application will display the statistics of the captured packets.
